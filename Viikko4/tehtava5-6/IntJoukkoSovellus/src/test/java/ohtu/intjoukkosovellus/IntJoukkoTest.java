...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.tarkistaKuuluukoLukuJoukkoon(10));
        assertFalse(joukko.tarkistaKuuluukoLukuJoukkoon(5));
        assertTrue(joukko.tarkistaKuuluukoLukuJoukkoon(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.tarkistaKuuluukoLukuJoukkoon(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.tarkistaKuuluukoLukuJoukkoon(11));
        joukko.poista(11);
        assertFalse(joukko.tarkistaKuuluukoLukuJoukkoon(11));
